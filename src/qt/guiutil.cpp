...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "BLON.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("BLON-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  blon-qt [" + tr("command-line options") + "]                     " + "\n";
